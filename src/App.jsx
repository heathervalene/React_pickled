...
function App() {
  ...
  const recipes = [
    ...
    },
    {
      ...
      ingredients: [
        { name: 'Kirby or Persion cucumbers' , measurements: '3-5 depending on size'},
        { name: 'Kosher salt', measurements: ' 1 1/2 tablespoons'}, 
        { name: 'Red onion', measurements: '1 small red onion'},
        { name: 'Granulated white sugar', measurements: '1 cup'},
        { name: 'White vinegar', measurements: '1 cup'},
        {name : 'Apple cider vinegar', measurements: '1/2 cup'},
        {name: 'Light brown sugar', measurements: '1/4 cup'},
        { name: 'mustard seeds', measurements: '1 1/2 teaspoons'},
        {name: 'Celery seeds', measurements: '1/2 teaspoon'},
        {name: 'Ground tumeric', measurements: '1/8 teaspoon'},
      ],
      instructions: [
        {
          step: '1',
        ...
        {
          step: '2',
          text: 'Boil all liquids and seasonings until the sugar is dissolved'
        },
        {
          step: '3',
          text: 'Pour hot vingar mixture over the cucumbers in the jar'
        },
        {
          step: '4',
